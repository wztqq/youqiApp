<template>
    <div class="scgl scgl-tab">
        <van-tabs v-model="activeName" class="sec-nav" type="border-card">
            <van-tab title="库存监管" name="first" :key="'first'">
                <child1></child1>
            </van-tab>
            <van-tab title="油气运输" name="second" :key="'second'">
                <child2></child2>
            </van-tab>
...
<script>
    import kucunjianguan from './kucunjianguan.vue'
    import youqiyunshu from './youqiyunshu.vue'

    export default {
        name: 'Youqigongying',
        components: {
            child1: kucunjianguan,
            child2: youqiyunshu
        },
        data() {
            return {
