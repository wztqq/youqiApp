    ...
    <div style="position: relative; width: 100%; top: 93px;background-color: #dadbdb">
        ...
        <div id="produce_content" v-show="a">
            ...
            <div class="chart">
                ...
                <div class="echarts_two" id="echartsNine" v-show="i2"></div>
            </div>
            <div class="chart">
                <div style=" width: 100%;height: 8px;background-color: #dadbdb;margin-bottom: 10px;"></div>
                <div style="font: bold 16px '微软雅黑'; width: 150px; position: relative;top: 10px;left: 20px;">油田产量分布分析
                </div>
        ...
        <div id="produce_content" v-show="b">
            ...
            <div class="chart">
                ...
                <div class="echarts_two" id="echartsThirteenth" v-show="j3"></div>
                <div class="echarts_two" id="echartsFourteen" v-show="j4"></div>
            </div>
            <div class="chart">
                <div style=" width: 100%;height: 8px;background-color: #dadbdb;margin-bottom: 10px;"></div>
                <div style="font: bold 16px '微软雅黑'; width: 150px; position: relative;top: 10px;left: 20px;">平均负荷率变化趋势
                </div>
        ...
        <div id="produce_content" v-show="c">
            ...
            <div class="chart">
                ...
                <div class="echarts_two" id="echartsEighteenth" v-show="k4"></div>
            </div>
            <div class="chart">
                <div style=" width: 100%; height: 8px; background-color: #dadbdb; margin-bottom: 10px;"></div>
                <div class="tab_oil">
        ...
        <div id="produce_content" v-show="d">
            ...
            <div class="pagefour_tc" v-show="produce_tc">
                <ul>
                    <li>{{page_c1}}</li>
                    <li>企业数量：<span>{{page_c2}}</span>人</li>
            ...
            <div class="chart">
                <div class="tab_oil">
                    <span v-for="(item, index) in tablist_seven" :key="index" @click="tabButton_seven(index)"
                          v-bind:class="[{ tab_oil_two: index == selected_seven},{ tab_oil_one: true },]">{{ item }}</span>
                </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                tablist_nine: ["单位产品原料煤耗", "单位产品综合能耗"],
                selected: "0",
                selected_one: "0",
                selected_two: "0",
                selected_three: "0",
...
//原油第一栏
            YuanYou_One(name, arry) {
                ...
                myChart.setOption({
                    tooltip: {
                        trigger: "axis",
                        formatter: '{a0}{b0}: {c0}万吨<br /> {a1}{b1}: {c1}%',
                        axisPointer: {
                            type: "cross",
                            crossStyle: {
                                color: "#999",
                    ...
                    series: [
                        {
                            ...
                            data: [203, 210, 197, 198, 192, 198, 231, 200, 210, 220],
                        },
                        {
                            name: "同比变化",
                            type: "line",
...
//煤制油第一栏
            ...
            MeiZhiYou_Two(name, arry) {
                ...
                myChart.setOption({
                    ...
                    series: [{
                        name: '水资源用量',
                        data: [86,82,84,75,79,83,79,86,82,84],
                        type: 'line',
                        symbol: 'none',
                        smooth: true,
                        areaStyle: {
