  ...
  <div>
    <div id="confess_content" style="background-color: #dadbdb">
      ...
      <div class="chart module">
        ...
        <div v-show="three">
          <div class="fontSize_div">
            <div class="fontSize" style="top:74px">46.55</div>
...
export default {
  ...
  data() {
    return {
      ...
      tablist_one_copy: ["12月汽油消费结构分析", "12月柴油消费结构分析"],
      tablist_one: ["12月汽油消费结构分析", "12月柴油消费结构分析"],
      tablist_city: [
        "阿拉善盟",
        "乌海",
        "巴彦淖尔",
      ...
      tablist_two: ["12月成品油销售地区分布", "区内区外成品油销售量对比分析"],
      ...
      six: false,
      pie_one: 28.97,
      pie_oneAry: [28.97, 0.57, 0.72, 0.87, 3.46, 2.2, 1.76, 1.06, 1.87, 3.29, 2.48, 1.56, 1.76],
      pie_two: 17.58,
      pie_twoAry: [17.58, 0.9, 1.01, 0.49, 3.53, 1.26, 0.84, 0.9, 1.65, 2.44, 1.97, 1.14, 0.84],
      seriesOne: [
        [
          {
            value: 20.58,
        ...
        series: [
          {
            ...
            data: [29.6, 9.41, 21, 26.52, 27.44, 29.66, 28.72, 31.02, 28.61, 50.23, 43.13,28.97],
          },
          {
            name: "汽油消费量预测值",
            type: "line",
            ...
            data: [28.6, 10.41, 18, 25.52, 23.44, 32.66, 29.72, 32.02, 26.61, 48.23, 41.13,26.97],
          },
        ],
      });
    },
        ...
        series: [
          {
            ...
            data: [20.92, 26.13, 45.95, 49.79, 51.99, 43.43, 35.35, 28.07, 40, 70.26, 67.67,25.24],
          },
          {
            name: "柴油消费量预测值",
            type: "line",
            ...
            data: [26.92, 29.13, 42.95, 45.79, 53.99, 46.43, 38.35, 26.07, 45, 76.26, 63.67,28.24],
          },
        ],
      });
    },
