<template>
  <div style="position: relative; width: 100%; top: 93px; background-color: #dadbdb">
    ...
    <!-- 动态点击切换按钮 -->
        <div class="clickbtn" :style="{'left':be_click_left(0.26),'top':be_click_top(0.7)}" @click.prevent="tanchuang(produce_tc,arry1,1)"></div>
        <div class="clickbtn" :style="{'left':be_click_left(0.35),'top':be_click_top(0.74)}" @click.prevent="tanchuang(produce_tc,arry2,2)"></div>
        <div class="clickbtn" :style="{'left':be_click_left(0.395),'top':be_click_top(0.678)}" @click.prevent="tanchuang(produce_tc,arry3,3)"></div>
        <div class="clickbtn" :style="{'left':be_click_left(0.473),'top':be_click_top(0.621)}" @click.prevent="tanchuang(produce_tc,arry4,4)"></div>
        <div class="clickbtn" :style="{'left':be_click_left(0.77),'top':be_click_top(0.226)}" @click.prevent="tanchuang(produce_tc,arry5,5)"></div>
        <div class="clickbtn" :style="{'left':be_click_left(0.627),'top':be_click_top(0.546)}" @click.prevent="tanchuang(produce_tc,arry6,6)"></div>
      <div class="chart">
        <div class="tab_oil">
...
YunShu_Two(name, arry) {
    ...
    series: [{
        data: [120, 200, 332, 450, 590, 630, 620],
        type: 'line',
        color: 'orange' ,
    }]
      });
